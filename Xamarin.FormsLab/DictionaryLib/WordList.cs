...
namespace DictionaryLib
{
    public class WordList :IWordList
    {
        ...
        public WordList()
        {
            ...
            //LoadDictionary("wordgame_dictionary.txt");
        }
        ...
        public string[] ReturnAnagramWords(string letters, int min = 3, int max = 7)
        {
        ...
        public WordInfo[] SearchWords(string text)
        {
            return Words.Where(x => x.Word.Contains(text.ToUpper()))
                        .ToArray();
        }
    }
}
